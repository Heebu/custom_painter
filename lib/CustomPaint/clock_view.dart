...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var fillBrush = Paint()..color = CupertinoColors.activeGreen;
    var innerBrush = Paint()..color = CupertinoColors.white;
    ...
    var secBrush = Paint()
      ..shader =
          const RadialGradient(colors: [Colors.orange, Colors.yellowAccent])
